function [output1 output2] = lk3(img1,img2)
...
ORIGINAL_IMAGE_1=img1;

ORIGINAL_IMAGE_2=img2;
...
for i=(1+floor(neighborhood_size/2)):(height-floor(neighborhood_size/2))
    ...
    for j=(1+floor(neighborhood_size/2)):(width-floor(neighborhood_size/2))
        ...
        output1(i,j)=floor(result(1,1));

        output2(i,j)=floor(result(2,1));
